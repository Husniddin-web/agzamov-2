  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden border-t border-zinc-100">
      <Container className="relative z-10 space-y-16">
        ...
        <div data-aos="fade-up" data-aos-duration="800" className="max-w-3xl mx-auto space-y-4">
              ...
              >
                  ...
                  <span
                    className={`p-2 rounded-xl border transition-all duration-300 shrink-0 ${
                      isOpen
                        ...
                        : 'bg-zinc-100 border-zinc-200 text-zinc-600 group-hover:bg-zinc-200'
                    }`}
                  >
                ...
                >
                  <div className="overflow-hidden">
                    <div className="px-6 sm:px-7 pb-6 pt-0 border-t border-zinc-100 text-sm sm:text-base text-zinc-600 leading-relaxed">
